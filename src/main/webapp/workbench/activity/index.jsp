...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#activityBody").on("click",$("input[name=xz]"),function (){
			$("#allXuan").prop("checked",$("input[name=xz]").length == $("input[name=xz]:checked").length)
		})
			...
			if ($xz.length == 0){
				...
				$.ajax({
					...
					success : function (data){
						...
						$("#edit-id").val(data.data.activity.id);
						$("#edit-name").val(data.data.activity.name);
						$("#edit-owner").val(data.data.activity.owner);
						$("#edit-startDate").val(data.data.activity.startDate);
						$("#edit-endDate").val(data.data.activity.endDate);
						$("#edit-cost").val(data.data.activity.cost);
						$("#edit-description").val(data.data.activity.description);
				...
				<table class="table table-hover">
					<thead>
						<tr style="color: #B3B3B3;">
							<td><input type="checkbox" id="allXuan" /></td>
							<td>名称</td>
                            <td>所有者</td>
							<td>开始日期</td>
							<td>结束日期</td>
