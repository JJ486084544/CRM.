...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#activityId").keydown(function (event){
                if (event.keyCode ==  13){
                ...
                <div class="btn-group" style="position: relative; top: 18%; left: 8px;">
                    <form class="form-inline" role="form">
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" style="width: 300px;" id = "activityId" placeholder="请输入市场活动名称，支持模糊查询">
