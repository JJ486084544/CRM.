    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#aname").keydown(function (event) {
                if (event.keyCode == 13) {
                    $.ajax({
                        url: "clue/searchActivityListByName.do",
                        data: {
                            name: $.trim($("#aname").val())
                        },
                        type: "post",
...
<div id="create-transaction2"
    ...
    <form action="clue/convert.do" id="transForm" method="post">
        ...
        <div class="form-group" style="width: 400px;position: relative; left: 20px;">
            ...
            <input type="text" class="form-control time" name="expecteDate">
        </div>
        <div class="form-group" style="width: 400px;position: relative; left: 20px;">
        ...
        <div class="form-group" style="width: 400px;position: relative; left: 20px;">
            <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="openSearchModal"
